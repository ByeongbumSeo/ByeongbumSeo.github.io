...
이외에 URL 링크, 이메일링크는 기본적으로 인식이 될 수 있는데, 만약 안된다면 `<>`를 사용하면 된다.
```markdown
...
![코드블록](https://docs.github.com/assets/cb-34231/mw-1440/images/help/writing/code-block-rendered.webp)
...
### 강조 블록
경고는 중요한 정보를 강조하는 데 사용할 수 있는 blockquote 구문의 확장이다.
...
아래 사이트에 모든 이모지의 markdown 표기법이 적혀있다.
